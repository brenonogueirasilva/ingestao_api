...
#Testar se o meotdo e capaz de me gerar uma lista de dicionarios que nao tenha uma lista, pois a API nao aceita listas
...
#Testar se e gerado um nome que contenha o nome de parametros que possuem lista
